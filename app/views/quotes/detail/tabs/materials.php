<div class="mb-5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-3 gap-3">
        <!-- <input type="search" id="searchEvent" 
            ...
            placeholder="Search..."
            name="search"
            hx-post="?c=Quotes&a=GetEvents&type=automation&id=<?= $id->id ?>"
        ...
        <button 
            ...
            hx-get="?c=Quotes&a=DetailModal&modal=material&id=<?= $id->id ?>"
    ...
    <table class="w-full border-collapse rounded-md overflow-hidden border border-gray-200" id="preventiveMaintenanceTable">
        <thead>
            <tr>
                <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Material</th>
                <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Cantidad</th>
                <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Valor</th>
                <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Notas</th>
