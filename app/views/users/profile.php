<div class="w-[95%] sm:w-[90%] bg-white p-4 rounded-lg shadow-lg relative z-40">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-lg p-4">
            <h2 class="text-lg font-semibold mb-4 text-gray-700">Datos Generales</h2>
            ...
            <input type="hidden" value="<?php echo $id->id ?>" id="id" name="id">
                ...
                <div class="mt-2">
                    ...
                    class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-black focus:outline-none" required>
                </div>
                <?php } ?>
                <div>
        ...
        <div class="bg-white rounded-lg p-4">
            <h2 class="text-lg font-semibold mb-4 text-gray-700">Actualizar Password</h2>
            <form hx-post='?c=Users&a=UpdatePassword' 
              ...
              <input type="hidden" value="<?php echo $id->id ?>" id="id" name="id">
							<div>
								...
								<input type="password" id="newpass" name="newpass" class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-black focus:outline-none" required>
							</div>
							<div class="mt-2">
								<label for="cpass" class="block text-gray-600 text-sm mb-1">Confirmar Password</label>
								<input type="password" id="cpass" name="cpass" class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-black focus:outline-none" required>
							</div>
							<div class="mt-6 flex justify-end">
									<button type="submit" class="bg-gray-900 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition"><i class="ri-save-line"></i> Actualizar Password</button>
							</div>
            </form>
        </div>
		</div>
